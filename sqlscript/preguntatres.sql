...
INSERT INTO nivel (id_nivel, descripcion) VALUES (1, 'Facil');

INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (1, '¿Cuál es la capital de Australia?', 0, 0, CURRENT_TIMESTAMP, 0, 1, 1);
...
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (2, '¿En qué continente se encuentra el desierto del Sahara?', 0, 0, CURRENT_TIMESTAMP, 0, 1, 1);
...
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (4, '¿En qué año cayó el Muro de Berlín?', 0, 0, CURRENT_TIMESTAMP, 0, 2, 1);
...
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (5, '¿Quién fue el primer presidente de Estados Unidos?', 0, 0, CURRENT_TIMESTAMP, 0, 2, 1);
...
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (6, '¿Qué civilización construyó las pirámides de Egipto?', 0, 0, CURRENT_TIMESTAMP, 0, 2, 1);
...
-- Pregunta 7
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (7, '¿Quién pintó "La noche estrellada"?', 0, 0, CURRENT_TIMESTAMP, 0, 3, 1);
...
-- Pregunta 8
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (8, '¿En qué país nació Leonardo da Vinci?', 0, 0, CURRENT_TIMESTAMP, 0, 3, 1);
...
-- Pregunta 9
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (9, '¿Qué técnica usó Miguel Ángel en la Capilla Sixtina?', 0, 0, CURRENT_TIMESTAMP, 0, 3, 1);
...
-- Pregunta 10
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (10, '¿Quién interpretó a Harry Potter en las películas?', 0, 0, CURRENT_TIMESTAMP, 0, 4, 1);
...
-- Pregunta 11
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (11, '¿Qué serie popular tiene un trono hecho de espadas?', 0, 0, CURRENT_TIMESTAMP, 0, 4, 1);
...
-- Pregunta 12
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (12, '¿Cuál es el nombre del personaje principal en "Breaking Bad"?', 0, 0, CURRENT_TIMESTAMP, 0, 4, 1);
...
-- Pregunta 13
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (13, '¿Cuál es el símbolo químico del agua?', 0, 0, CURRENT_TIMESTAMP, 0, 5, 1);
...
-- Pregunta 14
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (14, '¿Cuál es el planeta más grande del sistema solar?', 0, 0, CURRENT_TIMESTAMP, 0, 5, 1);
...
-- Pregunta 15
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (15, '¿Qué científico propuso la teoría de la relatividad?', 0, 0, CURRENT_TIMESTAMP, 0, 5, 1);
...
-- Pregunta 16
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (16, '¿Cuántos jugadores hay en un equipo de fútbol?', 0, 0, CURRENT_TIMESTAMP, 0, 6, 1);
...
-- Pregunta 17
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (17, '¿Qué país ganó el Mundial de Fútbol 2022?', 0, 0, CURRENT_TIMESTAMP, 0, 6, 1);
...
-- Pregunta 18
INSERT INTO pregunta (id, enunciado, cantidad_jugada, cantidad_aciertos, fecha_creacion, cantidad_reportes, id_categoria, id_nivel) VALUES (18, '¿En qué deporte se usa una raqueta y una red en cancha rectangular?', 0, 0, CURRENT_TIMESTAMP, 0, 6, 1);
